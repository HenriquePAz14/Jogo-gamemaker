Jogo de ação ambientado dentro de um editor de imagem.  
O jogador controla o cursor e utiliza ferramentas típicas de desenho como habilidades ofensivas e defensivas.
...
## 🕹️ Gênero
Shoot-em-up / Top-down shooter com estética de editor de imagem.

## 🧪 Estado do projeto
Atualmente em desenvolvimento.  
Pincel vermelho adicionado com alguns upgrades e inimigos basicos implementados.

## 📁 Tecnologias
Feito em **GameMaker Studio** usando GML.

## 📦 Como abrir o projeto
1. Baixe o repositório  
2. Abra o arquivo `.yyp` no GameMaker Studio  
3. Rode o jogo pela Room inicial

## ✨ Objetivo
Criar um shooter com mecânicas inspiradas em ferramentas de arte digital, misturando estética de “tela de pintura” com gameplay arcade.
